...
As we would like to identify interesting words for each group, we use [TF-IDF](https://en.wikipedia.org/wiki/Tf%E2%80%93idf) to weigh each term within each speech.
```{r}
